...
To start off let me recap my Research Question.
...
As blog post are typically more informal I will add some of my own thoughts to this blog post.
I not only believe I've shown this is true, but think there is even more to prove and explore with more variables that I can add onto this project. I think adding more variables and doing more research down into specific areas or even more states can add more substance to the project. 
...
To disclose any AI usage. **AI was used to help create assets style.scss and link scss structure to the pages.**
